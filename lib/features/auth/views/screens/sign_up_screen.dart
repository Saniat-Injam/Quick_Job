...
class SignUpScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final arguments = Get.arguments; // Get the passed arguments
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(
                  () => CustomDropdownField(
                    hintText: "Owner",
                    items: signUpController.statusList,
                    selectedValue: signUpController
                        .selectedStatus
                        .value, // This should be a String
                    onChanged: signUpController.troggleStatus,
                  ),
                ),

                //
                // CustomInputField(
                //   label: 'What is your role in this company?',
