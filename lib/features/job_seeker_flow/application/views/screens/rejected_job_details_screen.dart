...
class RejectedJobDetailsScreen extends StatelessWidget {
  final JobApplicationModel application;
  const RejectedJobDetailsScreen({super.key, required this.application});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // Bottom Bar to show Rejected Status
      bottomNavigationBar: Padding(
        ...
        child: GestureDetector(
          ...
          child: Container(
            ...
            height: 48.h,
            decoration: BoxDecoration(
              color: AppColors.bluePrimary, // Red for rejected
              borderRadius: BorderRadius.circular(8.r),
            ),
